class GitFindLargeFiles < Formula
  ...
  on_macos do
    url "https://github.com/prosser/git-find-large-files/releases/download/v0.0.1/git-find-large-files-macos-arm64-v0.0.1.tar.gz"
    sha256 "PUT_MACOS_SHA256_HASH_HERE"
  end

  on_linux do
    url "https://github.com/prosser/git-find-large-files/releases/download/v0.0.1/git-find-large-files-linux-x64-v0.0.1.tar.gz"
